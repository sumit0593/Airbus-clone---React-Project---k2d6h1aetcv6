  ...
  return (
    <div className="flex justify-center w-full bg-gray-800">
      {st ? (
        ...
        <div className="flex flex-col p-4 bg-blue-400 justify-center items-center w-4/5">
          <h1 className="text-3xl font-xl mt-2 mb-4">No ticket in your cart</h1>
          <h3 className="text-xl font-xl mt-2 mb-4">
            Make a safe jurney by airbus
          </h3>
          <img
      ...
      <div className="flex flex-col justify-center items-center bg-blue-200 p-4 w-3/5">
