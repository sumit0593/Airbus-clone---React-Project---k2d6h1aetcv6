...
const Payment = ({ data }) => {
  ...
  return (
    <div className="flex flex-col p-4 bg-blue-400 justify-evenly items-center w-4/5">
      <div className="flex flex-col justify-evenly items-center ">
        ...
        <div className="flex justify-evenly border-b-4 bg-amber-400 text-white">
          <div className="text-6xl font-medium place-self-center">
            {data.from}
          </div>
          <div className="flex flex-col">
            <img
              src="https://media1.giphy.com/media/LSL5oY5sdt75zm8uk6/giphy.gif?cid=ecf05e473nza57fa71tx3twcrk9wtg8493dqm1y4qkgscqt4&rid=giphy.gif&ct=s"
              alt="logo"
              width={130}
              height={80}
            />
        ...
        <div className="flex flex-col justify-center items-center border-b-1">
          <h1 className="text-xl my-1">
            <span className="text-xl">Duration: </span> {data.duration}{" "}
          </h1>
          <h1 className="text-xl my-1">
            <span className="text-xl">Airplane Name: </span>
            {data.airlineName}
          </h1>
        </div>
        <div className="flex justify-around items-center p-2 mt-5">
          <div className="mr-5 flex flex-col items-center">
            ...
            <div className="flex flex-col justify-evenly items-center p-1 border-b-1">
              ...
              <p className="text-xl">
                <span>Time: </span> {data.return.returnTime}
              </p>
            </div>
          </div>
          <div className="ml-5">
            <div className=" bg-blue-600 text-white flex flex-col justify-evenly items-center p-3 mt-2">
              ...
              <div className="border-b-1 mb-3">
                <h1 className="text-xl">
                  <span className="text-2xl">Flight Price: </span>Rs.{" "}
                  {data.price}
                </h1>
                <h1 className="text-xl">
                  <span className="text-2xl">Extra Charge: </span>Rs. 500
                </h1>
              </div>
              <h1 className="text-xl border-b-2 border-t-2 ">
